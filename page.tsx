      ...
      <div className="w-full max-w-sm">
        <div className="card p-8">
          <div className="mb-7">
            ...
            <p className="text-sm text-ink-500 mt-1">Start learning for free today.</p>
          </div>
          ...
          <p className="text-center text-xs text-ink-500 mt-5">
            ...
            <Link href="/auth/login" className="text-ink-800 font-medium hover:text-accent underline underline-offset-2">
              Sign in
            </Link>
          </p>
        </div>
